...
export function initializeSocket(httpServer: HTTPServer): Server {
  ...
  io.on('connection', async (socket: Socket) => {
    ...
    try {
      ...
      socket.on('space:create', (data, callback) =>
        roomHandler.handleCreateSpace(authSocket, data, callback)
      );
      socket.on('space:invite', (data, callback) =>
        roomHandler.handleInviteToSpace(authSocket, data, callback)
      );
      socket.on('space:leave', (data, callback) =>
        roomHandler.handleLeaveSpace(authSocket, data, callback)
      );
      socket.on('space:update', (data, callback) =>
        roomHandler.handleUpdateSpace(authSocket, data, callback)
      );
      socket.on('space:members', (data, callback) =>
        roomHandler.handleGetSpaceMembers(authSocket, data, callback)
      );
      socket.on('space:set_alias', (data, callback) =>
        roomHandler.handleSetMemberAlias(authSocket, data, callback)
      );

      // Chat Lock
      socket.on('room:lock', (data, callback) =>
        roomHandler.handleLockChat(authSocket, data, callback)
      );
      socket.on('room:get_locked', (data, callback) =>
        roomHandler.handleGetLockedRooms(authSocket, data, callback)
      );
      ...
      socket.on('message:read', data => messageHandler.handleMessageRead(authSocket, data));
      ...
      // Polls
      socket.on('poll:vote', data => pollHandler.handleVote(authSocket, data));
      ...
      // Typing Indicators
      socket.on('typing:start', data => typingHandler.handleTypingStart(authSocket, data));
      socket.on('typing:stop', data => typingHandler.handleTypingStop(authSocket, data));

      // Heartbeat for presence
      socket.on('heartbeat', () => presenceHandler.handleHeartbeat(authSocket));
      ...
      // Group Calls
      socket.on('call:join_group', data =>
        callHandler.handleJoinGroupCall(authSocket, data.roomId)
      );
      socket.on('call:leave_group', data =>
        callHandler.handleLeaveGroupCall(authSocket, data.roomId)
      );
