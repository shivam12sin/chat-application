...
class ConstellationHandler {
  ...
  async handleUpdateConstellation(
    ...
    try {
      ...
      const updated = await ConstellationRepository.updateConstellation(userId, constellationId, {
        name: name?.trim(),
  ...
  async handleGetMessages(
    ...
    try {
      ...
      const messages = await ConstellationRepository.getConstellationMessages(
        userId,
        constellationId
      );
      callback({ messages });
  ...
  async handleGetConstellationsForMessage(
    ...
    try {
      ...
      const constellationIds = await ConstellationRepository.getConstellationsForMessage(
        userId,
        messageId
      );
