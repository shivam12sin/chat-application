        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-mono-glass-border">
              ...
              <button
                onClick={onClose}
                className="p-2 text-mono-muted hover:text-mono-text rounded-full hover:bg-mono-surface transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-6">
              ...
              {step === "select" && (
                <div className="space-y-4">
                  <p className="text-mono-muted text-sm mb-4">
                    Select a verification method to secure your account:
                  </p>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-mono-text font-medium">
                        Authenticator App
                      </h3>
                      <p className="text-mono-muted text-xs">
              ...
              {step === "setup_totp" && (
                <div className="space-y-6">
                  ...
                  <div
                    className="flex items-center gap-2 p-3 bg-mono-surface rounded-lg text-xs text-mono-muted break-all justify-between group cursor-pointer"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-semibold text-mono-muted uppercase">
                      Enter Code
                    </label>
                    <input
                      type="text"
                  ...
                  <button
                    ...
                    className="w-full text-xs text-mono-muted hover:text-mono-text py-2"
                  >
                    Back
                  </button>
                </div>
              ...
              {step === "success" && (
                <div className="flex flex-col items-center justify-center py-8 space-y-4">
                  ...
                  <p className="text-mono-muted text-center text-sm">
