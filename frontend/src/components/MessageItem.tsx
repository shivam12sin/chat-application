        ...
        return (
          <div className="relative group/image">
            <img
              ...
              onClick={() =>
                window.open(message.metadata?.url || message.content, "_blank")
              }
            />
          </div>
        );
      ...
      case "file":
        return (
          ...
          >
            ...
            <svg
              className="w-5 h-5 text-mono-muted group-hover/file:text-mono-text transition-colors"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      case "poll":
        ...
        return (
          <div className="min-w-[250px] space-y-2">
            <h4 className="font-medium text-mono-text mb-2">
              {pollData?.question}
            </h4>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative p-2 flex justify-between items-center z-10">
                    ...
                    <span className="text-xs text-mono-muted font-medium">
                      {percentage}%
                    </span>
                  </div>
                </button>
        ...
        >
          ...
          <div
            className={cn(
              ...
              (message.messageType === "image" ||
                message.messageType === "gif") &&
                "text-white drop-shadow-md absolute bottom-2 right-2",
            )}
          >
            <span>{timestamp}</span>
            {message.isOwn && message.status && (
              ...
              >
                ...
                {message.status === "failed" && (
                  <svg
                    className="w-3.5 h-3.5 text-mono-text/60"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
        ...
        >
          ...
          <div className="relative">
            ...
            <MessageOptionsMenu
              ...
              isOwn={message.isOwn}
              onReply={() =>
                onReply?.(message.id, message.sender.name, message.content)
              }
