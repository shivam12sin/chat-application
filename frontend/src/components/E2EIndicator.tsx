  ...
  if (selfHasE2E && !peerHasE2E) {
    return (
      ...
      >
        ...
        {showLabel && (
          <span className="text-xs font-medium">Not Encrypted</span>
        )}
      </div>
    );
  }
  ...
  if (!selfHasE2E && peerHasE2E) {
    return (
      ...
      >
        ...
        {showLabel && (
          <span className="text-xs font-medium">E2E Available</span>
        )}
      </div>
    );
  }
...
export function E2EMessageBadge({
  ...
  if (decryptedSuccessfully) {
    return (
      <span
        className="inline-flex items-center text-green-400/60"
  ...
  if (error) {
    return (
      <span
        className="inline-flex items-center text-red-400/60"
        title={`Decryption failed: ${error}`}
      >
        <svg
          className="w-3 h-3"
          fill="none"
  ...
  return (
    <span
      className="inline-flex items-center text-yellow-400/60"
      title="Encrypted (pending)"
    >
      <svg
        className="w-3 h-3"
        fill="none"
