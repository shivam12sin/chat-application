...
const PollCreator: React.FC<PollCreatorProps> = ({
  ...
  return (
    ...
    >
      <div>
        <label className="block text-sm font-medium text-mono-text mb-1">
          Question
        </label>
        <input
          type="text"
      ...
      <div className="space-y-2">
        ...
        {options.length < 10 && (
          <ChromeButton onClick={addOption} className="text-sm px-3 py-1">
            + Add Option
          </ChromeButton>
        )}
      </div>
      ...
      <div className="flex items-center gap-2 pt-2 border-t border-mono-glass-border">
        ...
        <label
          ...
          className="text-sm text-mono-text cursor-pointer"
        >
