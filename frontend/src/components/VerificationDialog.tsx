...
export function VerificationDialog({
  ...
  const { ownFingerprint, safetyNumber, isLoading, refresh } =
    useVerification(peerUserId);
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            <p className="text-white/70 text-sm">
              Compare this safety number with {peerUsername} to verify that your
              messages are end-to-end encrypted. The number should match on both
              devices.
            </p>
