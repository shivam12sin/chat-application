  ...
  return (
    <button
      ...
      className={cn(
        ...
        !isDanger &&
          "hover:bg-mono-surface/10 hover:border-white/10 hover:shadow-md",
        isDanger &&
          "hover:bg-red-500/20 hover:border-red-500/30 hover:shadow-[0_0_15px_rgba(239,68,68,0.2)]",

        // 4. CLICK / ACTIVE (Pressure)
        !isDanger &&
          "active:bg-mono-surface/15 active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] active:border-white/5",
        isDanger &&
          "active:bg-red-500/25 active:shadow-[inset_0_2px_4px_rgba(127,29,29,0.4)] active:border-red-500/20",
