...
const MyDetailsModal: React.FC<MyDetailsModalProps> = ({
  isOpen,
  onClose,
  user,
  token,
              ...
              <div className="flex flex-col items-center justify-center text-center">
                ...
                >
                  <Avatar
                    ...
                    name={user.name}
                    size="xl"
                    className="mb-4 transition-opacity group-hover:opacity-75"
                  />
                ...
                <h3 className="text-xl font-bold text-mono-text">
                  {user.name}
                </h3>
