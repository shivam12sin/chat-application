            ...
            <div className="space-y-6">
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <h3 className="text-sm font-medium text-mono-muted mb-2">
                      Default
                    </h3>
              ...
              <section>
                ...
                <GlassPanel
                  variant="default"
                  interactive
                  onClick={() => success("Clicked!")}
                >
                  <p className="text-mono-text">
                    Click me! (hover for visual feedback)
                  </p>
                </GlassPanel>
              </section>
            </div>
          ...
          {activeTab === "modal" && (
            <div className="space-y-4">
              <section>
                ...
                <p className="text-mono-muted mb-6">
                  WAI-ARIA compliant modal with focus trap and keyboard
                  navigation
                </p>
                <button
