...
class SocketService {
  ...
  establishE2ESession(
    ...
    this.socket?.emit(
      "e2e:session_establish",
      { targetUserId, preKeyBundle },
      callback,
    );
  }
